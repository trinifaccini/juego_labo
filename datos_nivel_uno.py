...
item_dos = Item((30,30), (200, 450),0, 10, 'Recursos/Audio/ñam.mp3', "Recursos/Obstaculos/hamburguesa.png")
...
nivel_uno = Nivel(fondo, lista_plataformas,enemigos, items,trampas, 60,2,4,1,5)
