...
class TextBox(Widget):
    def __init__(
            ...
            color_background,color_background_seleccionado,color_border,
            color_border_seleccionado, border_size ,font, font_size, font_color):
    ...
    def render(self):
        ...
        #superficie que se adapte a la del boton
        ...
        for evento in lista_eventos:
            if evento.type == pygame.MOUSEBUTTONDOWN:
                if self.slave_rect_collide.collidepoint(evento.pos):
                    #me hicieron click, esto no siempre va a funcionar
